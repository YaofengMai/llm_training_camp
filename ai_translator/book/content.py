...
class Content:
    def __init__(self, content_type, original, bbox, translation=None):
...
class TableContent(Content):
    def __init__(self, t, translation=None):
        data = t.extract()
        ...
        super().__init__(ContentType.TABLE, df, t.bbox)
    ...
    def get_original_as_str(self):
        return self.original.to_csv(header=True, index=False)